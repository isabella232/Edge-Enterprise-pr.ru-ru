...
1. В редакторе групповой политики перейдите в _*Административные *шаблоны> Microsoft Edge > расширения >* и выберите управление, какие расширения устанавливаются **молча.**
2. Выберите **Включено**.  
3. Щелкните **Показать**.

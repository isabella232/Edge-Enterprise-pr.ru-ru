...
1. Обновления Windows
   ...
   - Windows 11
   - Windows 10 версии 1909 — [KB5003698](https://support.microsoft.com/topic/june-15-2021-kb5003698-os-build-18363-1645-preview-1ecf117e-1f89-40f9-a0a5-ed5766737620) или более поздней версии  
...
Режим IE на питание от конфигурации списка веб-Enterprise режима. При определении и настройке сайтов в списке сайтов для использования режима IE пользователям больше не нужно ждать или возвращаться к автономным приложениям IE11.
...
>[!Note]
>Если пользователь находится на сайте, который уже находится в списке Enterprise режима организации, параметры перезагрузки в режиме (или выход) Internet Explorer будут видны, но будут вымять серый цвет.

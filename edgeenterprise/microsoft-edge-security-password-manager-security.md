...
> [!Note]
> Microsoft Edge теперь позволяет включить проверку подлинности перед возможностью автозаполнения. Это обеспечивает пользователям дополнительный уровень конфиденциальности и предотвращает использование их сохраненных паролей любыми пользователями, кроме них. Дополнительные сведения см. в [разделе "Дополнительная конфиденциальность сохраненных паролей"](https://support.microsoft.com/topic/additional-privacy-for-your-saved-passwords-31dbd670-e314-4901-a546-6f302548502e).  

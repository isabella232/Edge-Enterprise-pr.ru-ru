...
> [!Note]
> Microsoft Edge теперь предоставляет возможность включить проверку подлинности перед возможностью автозаполнения; Это обеспечивает пользователям дополнительный уровень конфиденциальности и не позволяет использовать сохраненные пароли кем-либо, кроме них. Дополнительные сведения см. в дополнительных сведениях о конфиденциальности [сохраненных паролей.](https://support.microsoft.com/topic/additional-privacy-for-your-saved-passwords-31dbd670-e314-4901-a546-6f302548502e)  

...
- Убедитесь, что у пользователей всегда есть рабочий профиль в Microsoft Edge. [Смотрите NonRemovableProfileEnabled](https://docs.microsoft.com/deployedge/microsoft-edge-policies#nonremovableprofileenabled)
- Ограничить вход в надежный набор учетных записей. [Смотрите RestrictSigninToPattern](https://docs.microsoft.com/deployedge/microsoft-edge-policies#restrictsignintopattern)
- Отключить или принудительно войти в браузер. [Смотрите BrowserSignin](https://docs.microsoft.com/deployedge/microsoft-edge-policies#browsersignin)

...
ms.locfileid: "11313437"
---
# <span data-ttu-id="31018-103">Политики Microsoft Edge WebView2</span><span class="sxs-lookup"><span data-stu-id="31018-103">Microsoft Edge WebView2 - Policies</span></span>
...
## <span data-ttu-id="31018-108">Доступные политики</span><span class="sxs-lookup"><span data-stu-id="31018-108">Available policies</span></span>
...
### [*<span data-ttu-id="31018-112">Параметры переопределения загрузчика</span><span class="sxs-lookup"><span data-stu-id="31018-112">Loader Override Settings</span></span>*](#loader-override-settings-policies)
...
|[<span data-ttu-id="31018-117">ReleaseChannelPreference</span><span class="sxs-lookup"><span data-stu-id="31018-117">ReleaseChannelPreference</span></span>](#releasechannelpreference)|<span data-ttu-id="31018-118">Настройка предпочитаемого порядка поиска каналов выпуска</span><span class="sxs-lookup"><span data-stu-id="31018-118">Set the release channel search order preference</span></span>|
  ...
  ## <span data-ttu-id="31018-119">Политики "Параметры переопределения загрузчика"</span><span class="sxs-lookup"><span data-stu-id="31018-119">Loader Override Settings policies</span></span>
  ...
  ### <span data-ttu-id="31018-121">BrowserExecutableFolder</span><span class="sxs-lookup"><span data-stu-id="31018-121">BrowserExecutableFolder</span></span>

  #### <span data-ttu-id="31018-122">Настройка расположения папки исполняемого файла браузера</span><span class="sxs-lookup"><span data-stu-id="31018-122">Configure the location of the browser executable folder</span></span>

  
  
  #### <span data-ttu-id="31018-123">Поддерживаемые версии:</span><span class="sxs-lookup"><span data-stu-id="31018-123">Supported versions:</span></span>
  ...
  #### <span data-ttu-id="31018-125">Описание</span><span class="sxs-lookup"><span data-stu-id="31018-125">Description</span></span>
...
<span data-ttu-id="31018-128">Чтобы задать значение для пути к папке, предоставьте имя и пару значения.</span><span class="sxs-lookup"><span data-stu-id="31018-128">To set the value for the folder path, provide a Value name and Value pair.</span></span> <span data-ttu-id="31018-129">Задайте имя значения для идентификатора пользовательской модели приложения или имя исполняемого файла.</span><span class="sxs-lookup"><span data-stu-id="31018-129">Set value name to the Application User Model ID or the executable file name.</span></span> <span data-ttu-id="31018-130">Вы можете использовать подстановочный знак "\*" в качестве имени значения для применения ко всем приложениям.</span><span class="sxs-lookup"><span data-stu-id="31018-130">You can use the "\*" wildcard as value name to apply to all applications.</span></span>
  ...
  #### <span data-ttu-id="31018-131">Поддерживаемые функции:</span><span class="sxs-lookup"><span data-stu-id="31018-131">Supported features:</span></span>
  ...
  #### <span data-ttu-id="31018-135">Тип данных:</span><span class="sxs-lookup"><span data-stu-id="31018-135">Data Type:</span></span>

  - <span data-ttu-id="31018-136">Список строк</span><span class="sxs-lookup"><span data-stu-id="31018-136">List of strings</span></span>

  #### <span data-ttu-id="31018-137">Сведения и параметры Windows</span><span class="sxs-lookup"><span data-stu-id="31018-137">Windows information and settings</span></span>

  ##### <span data-ttu-id="31018-138">Сведения о групповой политике (ADMX)</span><span class="sxs-lookup"><span data-stu-id="31018-138">Group Policy (ADMX) info</span></span>
  ...
  ##### <span data-ttu-id="31018-144">Параметры реестра Windows</span><span class="sxs-lookup"><span data-stu-id="31018-144">Windows Registry Settings</span></span>
  ...
  ##### <span data-ttu-id="31018-149">Пример значения:</span><span class="sxs-lookup"><span data-stu-id="31018-149">Example value:</span></span>
...
```
  ...
  ### <span data-ttu-id="31018-151">ReleaseChannelPreference</span><span class="sxs-lookup"><span data-stu-id="31018-151">ReleaseChannelPreference</span></span>

  #### <span data-ttu-id="31018-152">Настройка предпочитаемого порядка поиска каналов выпуска</span><span class="sxs-lookup"><span data-stu-id="31018-152">Set the release channel search order preference</span></span>

  
  
  #### <span data-ttu-id="31018-153">Поддерживаемые версии:</span><span class="sxs-lookup"><span data-stu-id="31018-153">Supported versions:</span></span>
  ...
  #### <span data-ttu-id="31018-155">Описание</span><span class="sxs-lookup"><span data-stu-id="31018-155">Description</span></span>
...
<span data-ttu-id="31018-158">Чтобы задать значение для предпочитаемого канала выпуска, предоставьте имя и пару значения.</span><span class="sxs-lookup"><span data-stu-id="31018-158">To set the value for the release channel preference, provide a Value name and Value pair.</span></span> <span data-ttu-id="31018-159">Задайте имя значения для идентификатора пользовательской модели приложения или имя исполняемого файла.</span><span class="sxs-lookup"><span data-stu-id="31018-159">Set value name to the Application User Model ID or the executable file name.</span></span> <span data-ttu-id="31018-160">Вы можете использовать подстановочный знак "\*" в качестве имени значения для применения ко всем приложениям.</span><span class="sxs-lookup"><span data-stu-id="31018-160">You can use the "\*" wildcard as value name to apply to all applications.</span></span>
  ...
  #### <span data-ttu-id="31018-161">Поддерживаемые функции:</span><span class="sxs-lookup"><span data-stu-id="31018-161">Supported features:</span></span>
  ...
  #### <span data-ttu-id="31018-165">Тип данных:</span><span class="sxs-lookup"><span data-stu-id="31018-165">Data Type:</span></span>

  - <span data-ttu-id="31018-166">Список строк</span><span class="sxs-lookup"><span data-stu-id="31018-166">List of strings</span></span>

  #### <span data-ttu-id="31018-167">Сведения и параметры Windows</span><span class="sxs-lookup"><span data-stu-id="31018-167">Windows information and settings</span></span>

  ##### <span data-ttu-id="31018-168">Сведения о групповой политике (ADMX)</span><span class="sxs-lookup"><span data-stu-id="31018-168">Group Policy (ADMX) info</span></span>
  ...
  ##### <span data-ttu-id="31018-174">Параметры реестра Windows</span><span class="sxs-lookup"><span data-stu-id="31018-174">Windows Registry Settings</span></span>
  ...
  ##### <span data-ttu-id="31018-179">Пример значения:</span><span class="sxs-lookup"><span data-stu-id="31018-179">Example value:</span></span>
...
## <span data-ttu-id="31018-181">См. также</span><span class="sxs-lookup"><span data-stu-id="31018-181">See also</span></span>

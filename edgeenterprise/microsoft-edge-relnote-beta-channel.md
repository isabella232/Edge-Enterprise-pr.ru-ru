...
- **Платежные инструменты теперь синхронизируются между устройствами**. Начиная с Microsoft Edge версии 92, вы можете синхронизировать платежные данные на устройствах, на которых вы вошли в систему.
Обратите внимание: это контролируемый выпуск компонентов, и в настоящее время он выполнен на 50%. Если вы не видите эту функцию, возвращайтесь сюда через некоторое время, потому что ее выпуск продолжается.
...
Обратите внимание: это контролируемый выпуск компонентов, и в настоящее время он выполнен на 25%. Если вы не видите эту функцию, возвращайтесь сюда через некоторое время, потому что ее выпуск продолжается.
...
- **Улучшения визуализации шрифтов.** Улучшена отрисовка текста для повышения четкости и уменьшения размытости.
Обратите внимание: это контролируемый выпуск компонентов, и в настоящее время он выполнен на 25%. Если вы не видите эту функцию, возвращайтесь сюда через некоторое время, потому что ее выпуск продолжается.

...
* **Режим Internet Explorer:**
   ...
   * Разрешите пользователям отправлять отзывы на сайтах, которым требуется режим IE. Пользователи могут отправлять вам отзывы с помощью параметра пользовательского интерфейса Microsoft Edge. Вы можете настроить отображение этого параметра пользовательского интерфейса с помощью групповой политики и выбрать, как получать соответствующие сведения (по электронной почте или в настраиваемой форме).
...
* **Безопасность:**
  ...
  * Microsoft Edge оповещает вас, если ваши пароли обнаружены среди украденных учетных данных в Интернете. Microsoft Edge сверяет ваши пароли с репозиторием известных украденных учетных данных и оповещает вас, если обнаружено соответствие.

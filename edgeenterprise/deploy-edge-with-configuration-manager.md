...
---
# Развертывание Microsoft Edge с помощью System Center Configuration Manager
...
### Запуск мастера создания приложений и создание приложения  
...
## Изменение свойств приложения и параметров развертывания
...
- В разделе **Главная**>**Свойства** выберите **Свойства**.  
 ...
 В диалоговом окне **Свойства приложения <application name\>** вы увидите представление элементов с вкладками, которые можно настроить для изменения режима работы приложения. Дополнительные сведения о параметрах, которые можно настроить, см. в разделе [Создание приложений](https://docs.microsoft.com/sccm/apps/deploy-use/create-applications).
...
### Добавление требования к типу развертывания
...
## Добавление содержимого приложения в точку распространения  
...
>[!TIP]
>Дополнительные сведения о точках распространения и управлении содержимым в диспетчере конфигураций см. в разделе [Развертывание и администрирование содержимого для System Center Configuration Manager](https://docs.microsoft.com/sccm/core/servers/deploy/configure/deploy-and-manage-content).  
...
### Чтобы просмотреть состояние развертывания:  
...
4. Перейдите на одну из следующих вкладок, чтобы просмотреть другие обновления состояния развертывания приложения.  
    ...
    >[!TIP]
    >Есть несколько способов мониторинга развертывания приложений. Дополнительные сведения см. в разделе [Мониторинг приложений на консоли System Center Configuration Manager](https://docs.microsoft.com/sccm/apps/deploy-use/monitor-applications-from-the-console).  
...
- [Создание и развертывание приложения с помощью System Center Configuration Manager](https://docs.microsoft.com/sccm/apps/get-started/create-and-deploy-an-application)

...
Если доступ к домену MSN.com ограничен для вашей организации, мы настоятельно рекомендуем дать пользователям доступ к [https://ntp.msn.com](https://ntp.msn.com) этому.

...
| Представление страницы |В настоящее время продвигается в [Microsoft Edge Insider Channels](https://www.microsoftedgeinsider.com/) |
| Клавишная навигация |87.0.664.41 |
| Рукописный ввод  | 80.0.361.48            |
| Настройка рукописного ввода | 83.0.478.54  |
| Выделить  | 81.0.416.53         |
| Текстовые заметки | В настоящее время продвигается в [Microsoft Edge Insider Channels](https://www.microsoftedgeinsider.com/) |
| Чтение вслух | 84.0.522.63  |
| Просмотр файлов с защитой Microsoft Information Protection (MIP) | Поддержка Windows в версии 80.0.361.48<br>Поддержка Mac в версии 81.0.416.53 |
|  Просмотр файлов с защитой управления правами на доступ к данным (IRM)  | 83.0.478.37            |
| Просмотр и проверка цифровых подписей | Доступно в каналах Canary и Dev. Над чем активно работает. |
...
Технология защиты [Microsoft Information Protection (MIP)](https://docs.microsoft.com/microsoft-365/compliance/protect-information?view=o365-worldwide&preserve-view=true) обеспечивает безопасную совместную работу пользователей при соблюдении политик соответствия требованиям, действующих в вашей организации. Действия, которые пользователи могут выполнять над защищенным файлом, определяются назначенными им правами доступа.

> [!IMPORTANT]
> Для MIP требуется лицензия. Дополнительные сведения см. в этом руководстве по [лицензированию Microsoft 365](https://docs.microsoft.com/office365/servicedescriptions/microsoft-365-service-descriptions/microsoft-365-tenantlevel-services-licensing-guidance/microsoft-365-security-compliance-licensing-guidance#information-protection).
...
Помимо файлов с защитой MIP, непосредственно в браузере также можно открывать PDF-файлы из защищенных библиотек SharePoint с [управлением правами на доступ к данным (IRM)](https://docs.microsoft.com/microsoft-365/compliance/set-up-irm-in-sp-admin-center?view=o365-worldwide&preserve-view=true).
